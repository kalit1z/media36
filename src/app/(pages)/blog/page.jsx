...
export const metadata = {
  title: {
		default: "Blog de Création de Sites Web et Astuces Digitales | Media360",
	},
  description: "Découvrez notre blog dédié à la création de sites web. Trouvez des conseils, des astuces et des tendances pour améliorer votre présence en ligne.",
}
...
async function Blog() {
  ...
  return (
    <>
      <PageBanner pageTitle={"Nos articles"} breadTitle={"Blog"} bgImage={"/img/photo/12.webp"} />
                  ...
                  <div className="col-lg-7">
                      ...
                      <div className="mil-filter mil-up mil-mb-90">
                          <div className="mil-filter-links">
                              <Link href="/blog" className="mil-current">Tous</Link>
