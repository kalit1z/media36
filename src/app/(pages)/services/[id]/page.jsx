...
export async function generateMetadata({ params }) {
    ...
    return {
        title: postData.title + " | Services | Media360",
    }
}
...
async function ServiceDetail( { params } ) {
  ...
  return (
    <>
      <PageBanner pageTitle={postData.title} breadTitle={postData.title} bgImage={"/img/photo/12.webp"} />
...
{postData.faq !== undefined && (
          <FaqSection faqData={postData.faq} />
        )}
                </div>
                <div className="col-lg-5">
