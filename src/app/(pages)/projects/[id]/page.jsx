...
export async function generateMetadata({ params }) {
  ...
  return {
      title: postData.title + " | Projets | Media360",
  }
}
              ...
              <div className="row">
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-prev-project mil-mb-60">
                          <h4 className="mil-upper mil-up mil-mb-30">Projet précédent</h4>
                          <Link href={`/projects/${prev.id}`} className="mil-link mil-left-link mil-upper mil-up">Travail précédent <span className="mil-arrow"><img src="/img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
                      }
                  </div>
                  <div className="col-md-6 col-lg-6">
                      ...
                      <div className="mil-next-project mil-mb-60">
                          <h4 className="mil-upper mil-up mil-mb-30">Prochain projet</h4>
                          <Link href={`/projects/${next.id}`} className="mil-link mil-upper mil-up">Travail suivant <span className="mil-arrow"><img src="/img/icons/1.svg" alt="arrow" /></span></Link>
                      </div>
                      }
                  </div>
              </div>
