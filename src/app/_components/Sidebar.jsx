  ...
  return (
    <>
        ...
        <div className="mil-sidebar-frame">
            <h6 className="mil-upper mil-up mil-mb-30">Nos Contacts</h6>

            <ul className="mil-list mil-dark mil-up mil-mb-30">
                <li className="mil-text-sm">info@media360.ch</li>
                <li className="mil-text-sm">contact@media360.ch</li>
            </ul>
            ...
            <h6 className="mil-upper mil-up mil-mb-30">Articles récents</h6>
            ...
            <h6 className="mil-upper mil-up mil-mb-30">Auteurs</h6>
